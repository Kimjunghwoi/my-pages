...
프로젝트 이름과 용도를 시각 예시보다 먼저 표시합니다. 자료 목록은 외부 링크 19개, 작업 기록 5개, 무료 템플릿 3개와 점검 도구 1개로 총 28개입니다. `project` 필터는 실제 서비스 세 개만, `record`는 작업 기록, `template`은 무료 양식과 점검 도구를 보여줍니다.
